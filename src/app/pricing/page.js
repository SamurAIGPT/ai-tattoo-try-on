...
const PLANS = [
  {
    ...
    credits: 1000,
    price: "$5",
    desc: "Great for testing out a few tattoo designs",
    features: [
      "~41 Tattoo Try-Ons",
  ...
  },
  {
    ...
    credits: 2000,
    price: "$10",
    desc: "Perfect for testing custom placements",
    features: [
      "~83 Tattoo Try-Ons",
      "Interactive Before/After View",
      "High-Resolution Image Downloads",
  ...
  },
  {
    ...
    credits: 4000,
    price: "$20",
    desc: "Ideal for enthusiasts and tattoo planning",
    popular: true,
    features: [
      "~166 Tattoo Try-Ons",
  ...
  },
  {
    ...
    credits: 10000,
    price: "$50",
    desc: "For professional artists and studios",
    features: [
      "~416 Tattoo Try-Ons",
    ...
    <div className="flex-1 overflow-y-auto bg-zinc-950 py-12 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          <span className="text-[10px] font-black uppercase tracking-wider text-violet-400 bg-violet-955/40 border border-violet-700 px-3.5 py-1.5 rounded-full shadow-sm">
            Credit Packages
          </span>
          ...
          <p className="text-sm text-zinc-300 mt-2 font-medium">
            No monthly subscriptions, use them whenever you need. Each AI tattoo try-on costs <strong className="text-violet-400">24 credits</strong>.
          </p>
        </div>

        {/* Transaction Alerts */}
        {success && (
          <div className="bg-emerald-955/20 border border-emerald-900/40 rounded-2xl p-6 mb-8 text-center max-w-xl mx-auto shadow-lg animate-in fade-in zoom-in duration-200">
            ...
            <p className="text-xs text-emerald-300/80 leading-relaxed mt-1 max-w-sm mx-auto">
              Your credits have been added successfully to your account. Return to the studio to try on new tattoos!
            </p>
            <button
              ...
              >
                ...
                <div>
                  ...
                  <ul className="space-y-2.5 text-xs text-zinc-200 mb-6 font-medium">
                    <li className="flex items-center gap-2 text-violet-300 font-bold bg-violet-955/40 border border-violet-900/50 px-2.5 py-1.5 rounded-lg mb-4">
